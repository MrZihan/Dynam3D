...
discrete_data = json.load(open("NAVRAG_val_unseen_enc.json","r"))
discrete_data_new = {}
...
json.dump(CE_data, open("navrag_val_unseen_data.json","w"))
json.dump(CE_data_gt, open("navrag_val_unseen_gt.json","w"))

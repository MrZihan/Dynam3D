...
discrete_data = json.load(open("REVERIE_train_enc.json","r"))
discrete_data_new = {}
...
for scene_id in scene_dict:
    json.dump(scene_dict[scene_id], open("reverie_training_data/"+scene_id.split("/")[-1]+".json","w"))

json.dump(CE_data_gt, open("reverie_train_gt.json","w"))